...
<!-- Mirrored from azim.commonsupport.com/Fionca/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Mar 2021 04:49:18 GMT -->
<head>
<meta charset="utf-8">
...
<?php include ('header.php');  ?>
    ...
    <section class="banner-section style-four">
        <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        <h1>Creative and Digital <br />Startup Agency</h1>
                        <p>Beniam quis nostrud exercitation sed lamco laboris nis aliquip sed conseqa sed <br />rure repreh derit luptate velit excepteur ocaan dcats ipsum aliquip</p>
                        <div class="btn-box">
                            <a href="index-2.html" class="theme-btn style-two">Work With Us</a>
            ...
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box centred">
                        <h1>Utilize The Affordable <br />Digital Services</h1>
                        <p>Beniam quis nostrud exercitation sed lamco laboris nis aliquip sed conseqa sed <br />rure repreh derit luptate velit excepteur ocaan dcats ipsum aliquip</p>
                        <div class="btn-box">
                            <a href="index-2.html" class="theme-btn style-two">Work With Us</a>
                            <a href="index-7.html" class="banner-btn-two">Our Portfolio</a>
                        </div>
                    </div> 
                </div>
            </div>
            <div class="slide-item">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        <h1>Our Process Ensures <br />Growing Business</h1>
                        <p>Beniam quis nostrud exercitation sed lamco laboris nis aliquip sed conseqa sed <br />rure repreh derit luptate velit excepteur ocaan dcats ipsum aliquip</p>
                        <div class="btn-box">
                            <a href="index-2.html" class="theme-btn style-two">Work With Us</a>
                            <a href="index-7.html" class="banner-btn">Learn More</a>
    ...
    <section class="feature-style-three">
        ...
        <div class="anim-icon">
            ...
            <div class="icon icon-2 float-bob-y" style="background-image: url(assets/images/icons/anim-icon-2.png);"></div>
        </div>
        <div class="auto-container">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-three wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <p>Repreh derit luptate velit excepteur ocaan dcats ipsum aliquip ...</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
    ...
    <!-- working-section -->
    <section class="working-section centred" style="background-image: url(assets/images/background/work-1.jpg);">
        <div class="auto-container">
    ...
    <section class="service-style-four">
        ...
        <div class="auto-container">
            <div class="sec-title-two">
                <h5>Fionca Startup Theme</h5>
                <h2>We Offer Creativity Solutions <br />For Many Companies</h2>
            </div>
            <div class="row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-four wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4><a href="service-1.html">Web Development</a></h4>
                            <p>Acepteur sintas haecat sed nods proidentyle sunt culpa sed ipsum sed ipsum tempor lorem ipsum dolor totam enrica.</p>
                            <div class="link"><a href="service-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-four wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4><a href="service-1.html">UX UI Design</a></h4>
                            <p>Acepteur sintas haecat sed nods proidentyle sunt culpa sed ipsum sed ipsum tempor lorem ipsum dolor totam enrica.</p>
                            <div class="link"><a href="service-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-four wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4><a href="service-1.html">SEO & Marketing</a></h4>
                            <p>Acepteur sintas haecat sed nods proidentyle sunt culpa sed ipsum sed ipsum tempor lorem ipsum dolor totam enrica.</p>
                            <div class="link"><a href="service-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-four wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4><a href="service-1.html">Full Video Editing</a></h4>
                            <p>Acepteur sintas haecat sed nods proidentyle sunt culpa sed ipsum sed ipsum tempor lorem ipsum dolor totam enrica.</p>
                            <div class="link"><a href="service-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-four wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4><a href="service-1.html">Content Writing</a></h4>
                            <p>Acepteur sintas haecat sed nods proidentyle sunt culpa sed ipsum sed ipsum tempor lorem ipsum dolor totam enrica.</p>
                            <div class="link"><a href="service-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-four wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4><a href="service-1.html">Startup Planning</a></h4>
                            <p>Acepteur sintas haecat sed nods proidentyle sunt culpa sed ipsum sed ipsum tempor lorem ipsum dolor totam enrica.</p>
                            <div class="link"><a href="service-1.html"><i class="fas fa-arrow-right"></i><span>Read More</span></a></div>
                        </div>
                    </div>
    ...
    <!-- funfact-style-three -->
    <section class="funfact-style-three bg-color-4">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                    <div id="content_block_11">
                        <div class="content-box">
                            ...
                            <div class="text">
                                <p>Unde omnis iste natus ero sit voluptatem accusantium dolor totam rem aperiam, eaque ipsa quae ab illo inventore verita architecto beatae vitae dicta sunt explicabo. </p>
                            </div>
                            <div class="video-btn">
                                <a href="https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s" class="lightbox-image" data-caption="" style="background-image: url(assets/images/resource/btn-bg-2.png);"><i class="fas fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="content-box">
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-12 counter-block">
                                    <div class="counter-block-three wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div class="icon-box"><i class="flaticon-briefcase"></i></div>
                                        <div class="count-outer count-box">
                                            <span class="count-text" data-speed="1500" data-stop="195">0</span>+
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 counter-block">
                                    <div class="counter-block-three wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div class="icon-box"><i class="flaticon-chat-bubble"></i></div>
                                        <div class="count-outer count-box">
            ...
            <div class="row align-items-center clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
                        ...
                        <figure class="image wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="assets/images/resource/skills-1.jpg" alt=""></figure>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div id="content_block_13">
                        <div class="content-box">
                            ...
                            <div class="text">
                                <p>Exercitation llamco laboris nis aliquip sed conseqrure dolorn repreh velit excepteur duis aute irure dolor voluptate voluptatem accusa ntia antium, totam rem aperiam, eaque ipsa quae ab illo inventore verita dui architecto beatae labore et dolore magna.</p>
                            </div>
    ...
    <section class="project-style-three centred">
        <div class="auto-container">
            ...
            <div class="sortable-masonry">
                <div class="filters">
                    <ul class="filter-tabs filter-btns centred clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".startups">Startups</li>
                        <li class="filter" data-role="button" data-filter=".planning">Business Planning</li>
                        <li class="filter" data-role="button" data-filter=".marketing">Marketing</li>
                    </ul>
                </div>
                <div class="items-container row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all planning consulting startups">
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/gallery/project-9.jpg" alt="">
                                    <a href="assets/images/gallery/project-9.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all startups consulting planning">
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/gallery/project-10.jpg" alt="">
                                    <a href="assets/images/gallery/project-10.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all planning startups marketing">
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/gallery/project-11.jpg" alt="">
                                    <a href="assets/images/gallery/project-11.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
                        ...
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    <a href="assets/images/gallery/project-12.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
                        ...
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    <a href="assets/images/gallery/project-13.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all consulting planning marketing">
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/gallery/project-14.jpg" alt="">
                                    <a href="assets/images/gallery/project-14.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
                        ...
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    <a href="assets/images/gallery/project-15.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all consulting startups">
                        <div class="project-block-two">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/gallery/project-16.jpg" alt="">
                                    <a href="assets/images/gallery/project-16.jpg" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-plus-1"></i></a>
                                </figure>
                                <div class="content-box">
                                    <h5>Thoughtful Solutions</h5>
                                    <a href="index-5.html">Consulting</a>
            ...
            <div class="more-btn"><a href="index-5.html" class="theme-btn"><i class="flaticon-waiting"></i>Load More</a></div>
        </div>
    </section>
    ...
    <section class="team-style-two bg-color-1">
        ...
        <div class="anim-icon">
            <div class="icon icon-1 rotate-me" style="background-image: url(assets/images/icons/anim-icon-1.png);"></div>
            <div class="icon icon-2 float-bob-y" style="background-image: url(assets/images/icons/anim-icon-4.png);"></div>
        </div> 
        <div class="auto-container">
            <div class="sec-title-two">
                <h5>Fionca Startup Theme</h5>
                <h2>Digital Minds Always Spell Around Creativity</h2>
            </div>
            <div class="three-item-carousel owl-carousel owl-theme owl-dots-none">
                <div class="team-block-two">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h3><a href="index-5.html">Christian Roy</a></h3>
                ...
                <div class="team-block-two">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h3><a href="index-5.html">Paul Wilson</a></h3>
                ...
                <div class="team-block-two">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h3><a href="index-5.html">Amanda Timmy</a></h3>
    ...
    <section class="testimonial-section alternet-3">
        <div class="auto-container">
            <div class="sec-title-two centred">
                <h2>What Happy Clients Says</h2>
            </div>
            <div class="testimonial-inner">
                <figure class="quote-box"><img src="assets/images/icons/quote.png" alt=""></figure>
                <div class="client-testimonial-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    <div class="testimonial-block">
                        <div class="text">
                            <p>Aspernatur aut odit aut fugit sed quia consequuntur magni dolores eosui ratione voluptatem sequi nesciunt. Neque porro quisquam estm qui dolorem ipsum quia dolor sit amet consectetur, adipisci velit sed quia non numquam eius modi tempora incidunt ut labore et dolore magnay aliquam sd ipsum quaerat voluptatem.</p>
                        </div>
                    </div>
                    <div class="testimonial-block">
                        <div class="text">
...
<!-- Mirrored from azim.commonsupport.com/Fionca/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Mar 2021 04:51:25 GMT -->
</html>
